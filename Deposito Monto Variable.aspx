<%@ Page Title="Cajero" Language="C#" AutoEventWireup="true" CodeFile="Deposito Monto Variable.aspx.cs" Inherits="_Default" %>
...
<!--Este es el estilo de la pagina-->
	...
	<body>
        <form id="DepositoMontoVariable" runat="server">
